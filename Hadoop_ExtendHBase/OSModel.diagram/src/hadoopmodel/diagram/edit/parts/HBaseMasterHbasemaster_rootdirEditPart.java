 ...
 * @generated
 */
public class HBaseMasterHbasemaster_rootdirEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public HBaseMasterHbasemaster_rootdirEditPart(View view) {
		super(view);
	}
			...
			parser = HadoopStackParserProvider
					.getParser(
							...
							HadoopStackVisualIDRegistry
									.getType(hadoopmodel.diagram.edit.parts.HBaseMasterHbasemaster_rootdirEditPart.VISUAL_ID));
		}
		return parser;
	}
