 ...
 * @generated
 */
public class HBaseMasterHbasemaster_hostOnReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public HBaseMasterHbasemaster_hostOnReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Server && newEnd instanceof HBaseMaster)) {
			return false;
		}
		return HadoopStackBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistHBaseMasterHbasemaster_hostOn_4010(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return HadoopStackBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistHBaseMasterHbasemaster_hostOn_4010(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setHbasemaster_hostOn(null);
		getNewSource().setHbasemaster_hostOn(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setHbasemaster_hostOn(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
