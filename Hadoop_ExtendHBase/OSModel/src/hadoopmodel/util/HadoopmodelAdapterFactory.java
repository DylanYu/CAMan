...
public class HadoopmodelAdapterFactory extends AdapterFactoryImpl {
	...
	protected HadoopmodelSwitch<Adapter> modelSwitch =
		new HadoopmodelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseHBaseMaster(HBaseMaster object) {
				return createHBaseMasterAdapter();
			}
			@Override
			public Adapter caseHBaseRegionServer(HBaseRegionServer object) {
				return createHBaseRegionServerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link hadoopmodel.HBaseMaster <em>HBase Master</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link hadoopmodel.HBaseRegionServer <em>HBase Region Server</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
