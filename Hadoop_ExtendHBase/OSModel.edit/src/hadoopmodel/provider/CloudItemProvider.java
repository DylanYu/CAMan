...
public class CloudItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HadoopmodelPackage.Literals.CLOUD__HBASEMASTER);
			childrenFeatures.add(HadoopmodelPackage.Literals.CLOUD__HBASEREGIONSERVER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HadoopmodelPackage.Literals.CLOUD__HBASEMASTER,
				 HadoopmodelFactory.eINSTANCE.createHBaseMaster()));

		newChildDescriptors.add
			(createChildParameter
				(HadoopmodelPackage.Literals.CLOUD__HBASEREGIONSERVER,
				 HadoopmodelFactory.eINSTANCE.createHBaseRegionServer()));
	}
