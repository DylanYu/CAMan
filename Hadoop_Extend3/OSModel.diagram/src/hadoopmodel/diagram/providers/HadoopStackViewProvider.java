...
public class HadoopStackViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return ServerEditPart.VISUAL_ID == visualID
				...
				|| HBaseMasterEditPart.VISUAL_ID == visualID
				|| HDFSNameNodeEditPart.VISUAL_ID == visualID
				|| HBaseRegionServerEditPart.VISUAL_ID == visualID
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case HDFSDataNodeEditPart.VISUAL_ID:
			return createHDFSDataNode_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case HBaseMasterEditPart.VISUAL_ID:
			return createHBaseMaster_2007(domainElement, containerView, index,
					persisted, preferencesHint);
		case HDFSNameNodeEditPart.VISUAL_ID:
			return createHDFSNameNode_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		case HBaseRegionServerEditPart.VISUAL_ID:
			return createHBaseRegionServer_2008(domainElement, containerView,
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case HBaseRegionServerHbaseregionserver_connectToEditPart.VISUAL_ID:
			return createHBaseRegionServerHbaseregionserver_connectTo_4009(
		...
		case HBaseMasterHbasemaster_hostOnEditPart.VISUAL_ID:
			return createHBaseMasterHbasemaster_hostOn_4010(containerView,
					index, persisted, preferencesHint);
		...
		case HBaseMasterHbasemaster_dependOnEditPart.VISUAL_ID:
			return createHBaseMasterHbasemaster_dependOn_4011(containerView,
					index, persisted, preferencesHint);
		case HBaseRegionServerHbaseregionserver_hostOnEditPart.VISUAL_ID:
			return createHBaseRegionServerHbaseregionserver_hostOn_4012(
					containerView, index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createHBaseMaster_2007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createHBaseRegionServer_2008(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Edge createHBaseRegionServerHbaseregionserver_connectTo_4009(
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createHBaseMasterHbasemaster_hostOn_4010(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createHBaseMasterHbasemaster_dependOn_4011(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createHBaseRegionServerHbaseregionserver_hostOn_4012(
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
