...
public class HadoopStackNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case HBaseMasterEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://www.sei.pku.edu.cn/rsa/hadoopmodel?HBaseMaster", HadoopStackElementTypes.HBaseMaster_2007); //$NON-NLS-1$
		case HBaseRegionServerEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://www.sei.pku.edu.cn/rsa/hadoopmodel?HBaseRegionServer", HadoopStackElementTypes.HBaseRegionServer_2008); //$NON-NLS-1$
		...
		case HBaseRegionServerHbaseregionserver_connectToEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://www.sei.pku.edu.cn/rsa/hadoopmodel?HBaseRegionServer?hbaseregionserver_connectTo", HadoopStackElementTypes.HBaseRegionServerHbaseregionserver_connectTo_4009); //$NON-NLS-1$
		case HBaseMasterHbasemaster_hostOnEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://www.sei.pku.edu.cn/rsa/hadoopmodel?HBaseMaster?hbasemaster_hostOn", HadoopStackElementTypes.HBaseMasterHbasemaster_hostOn_4010); //$NON-NLS-1$
		case HBaseMasterHbasemaster_dependOnEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://www.sei.pku.edu.cn/rsa/hadoopmodel?HBaseMaster?hbasemaster_dependOn", HadoopStackElementTypes.HBaseMasterHbasemaster_dependOn_4011); //$NON-NLS-1$
		case HBaseRegionServerHbaseregionserver_hostOnEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://www.sei.pku.edu.cn/rsa/hadoopmodel?HBaseRegionServer?hbaseregionserver_hostOn", HadoopStackElementTypes.HBaseRegionServerHbaseregionserver_hostOn_4012); //$NON-NLS-1$
		}
	...
	public String getText(View view) {
		...
		case HBaseMasterEditPart.VISUAL_ID:
			return getHBaseMaster_2007Text(view);
		case HBaseRegionServerEditPart.VISUAL_ID:
			return getHBaseRegionServer_2008Text(view);
		case HDFSNameNodeHdfsnamenode_hostOnEditPart.VISUAL_ID:
		...
		case HBaseRegionServerHbaseregionserver_connectToEditPart.VISUAL_ID:
			return getHBaseRegionServerHbaseregionserver_connectTo_4009Text(view);
		case HBaseMasterHbasemaster_hostOnEditPart.VISUAL_ID:
			return getHBaseMasterHbasemaster_hostOn_4010Text(view);
		case HBaseMasterHbasemaster_dependOnEditPart.VISUAL_ID:
			return getHBaseMasterHbasemaster_dependOn_4011Text(view);
		case HBaseRegionServerHbaseregionserver_hostOnEditPart.VISUAL_ID:
			return getHBaseRegionServerHbaseregionserver_hostOn_4012Text(view);
		}
	 ...
	 * @generated
	 */
	private String getHBaseMaster_2007Text(View view) {
		IParser parser = HadoopStackParserProvider
				.getParser(
						HadoopStackElementTypes.HBaseMaster_2007,
						view.getElement() != null ? view.getElement() : view,
						HadoopStackVisualIDRegistry
								.getType(HBaseMasterHbasemaster_rootdirEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(
					view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
	 ...
	 * @generated
	 */
	private String getHBaseRegionServer_2008Text(View view) {
		IParser parser = HadoopStackParserProvider
				.getParser(
						HadoopStackElementTypes.HBaseRegionServer_2008,
						view.getElement() != null ? view.getElement() : view,
						HadoopStackVisualIDRegistry
								.getType(HBaseRegionServerHbaseregionserver_nameEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(
					view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
	 ...
	 * @generated
	 */
	private String getHBaseRegionServerHbaseregionserver_connectTo_4009Text(
			View view) {
		return ""; //$NON-NLS-1$
	}
	 ...
	 * @generated
	 */
	private String getHBaseMasterHbasemaster_hostOn_4010Text(View view) {
		return ""; //$NON-NLS-1$
	}
	 ...
	 * @generated
	 */
	private String getHBaseMasterHbasemaster_dependOn_4011Text(View view) {
		return ""; //$NON-NLS-1$
	}
	 ...
	 * @generated
	 */
	private String getHBaseRegionServerHbaseregionserver_hostOn_4012Text(
			View view) {
		return ""; //$NON-NLS-1$
	}
