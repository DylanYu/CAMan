...
import hadoopmodel.diagram.edit.policies.HadoopStackTextSelectionEditPolicy;
 ...
 * @generated
 */
public class HBaseRegionServerHbaseregionserver_nameEditPart extends
	 ...
	 * @generated
	 */
	public HBaseRegionServerHbaseregionserver_nameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new HadoopStackTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return HadoopStackElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = HadoopStackParserProvider
					.getParser(
							HadoopStackElementTypes.HBaseRegionServer_2008,
							getParserElement(),
							HadoopStackVisualIDRegistry
									.getType(hadoopmodel.diagram.edit.parts.HBaseRegionServerHbaseregionserver_nameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					HadoopStackEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
