 ...
 * @generated
 */
public class JavaItemSemanticEditPolicy extends
		HadoopStackBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public JavaItemSemanticEditPolicy() {
		super(HadoopStackElementTypes.Java_2003);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (HadoopStackVisualIDRegistry.getVisualID(outgoingLink) == JavaJava_hostOnEditPart.VISUAL_ID) {
