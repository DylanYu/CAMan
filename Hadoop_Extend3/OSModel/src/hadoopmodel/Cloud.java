 ...
 *   <li>{@link hadoopmodel.Cloud#getHbasemaster <em>Hbasemaster</em>}</li>
 *   <li>{@link hadoopmodel.Cloud#getHbaseregionserver <em>Hbaseregionserver</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Cloud extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Hbasemaster</b></em>' containment reference list.
	 * The list contents are of type {@link hadoopmodel.HBaseMaster}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Hbasemaster</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Hbasemaster</em>' containment reference list.
	 * @see hadoopmodel.HadoopmodelPackage#getCloud_Hbasemaster()
	 * @model containment="true"
	 * @generated
	 */
	EList<HBaseMaster> getHbasemaster();

	/**
	 * Returns the value of the '<em><b>Hbaseregionserver</b></em>' containment reference list.
	 * The list contents are of type {@link hadoopmodel.HBaseRegionServer}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Hbaseregionserver</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Hbaseregionserver</em>' containment reference list.
	 * @see hadoopmodel.HadoopmodelPackage#getCloud_Hbaseregionserver()
	 * @model containment="true"
	 * @generated
	 */
	EList<HBaseRegionServer> getHbaseregionserver();
