...
public class HadoopmodelPackageImpl extends EPackageImpl implements HadoopmodelPackage {
	 ...
	 * @generated
	 */
	private EClass hBaseMasterEClass = null;
	 ...
	 * @generated
	 */
	private EClass hBaseRegionServerEClass = null;
	 ...
	 * @generated
	 */
	public EReference getCloud_Hbasemaster() {
	 ...
	 * @generated
	 */
	public EReference getCloud_Hbaseregionserver() {
		return (EReference)cloudEClass.getEStructuralFeatures().get(10);
	}
	 ...
	 * @generated
	 */
	public EClass getHBaseMaster() {
		return hBaseMasterEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getHBaseMaster_Hbasemaster_rootdir() {
		return (EAttribute)hBaseMasterEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getHBaseMaster_Hbasemaster_dependOn() {
		return (EReference)hBaseMasterEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getHBaseMaster_Hbasemaster_hostOn() {
		return (EReference)hBaseMasterEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getHBaseRegionServer() {
		return hBaseRegionServerEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getHBaseRegionServer_Hbaseregionserver_name() {
		return (EAttribute)hBaseRegionServerEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getHBaseRegionServer_Hbaseregionserver_connectTo() {
		return (EReference)hBaseRegionServerEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getHBaseRegionServer_Hbaseregionserver_hostOn() {
		return (EReference)hBaseRegionServerEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(cloudEClass, CLOUD__HBASEMASTER);
		createEReference(cloudEClass, CLOUD__HBASEREGIONSERVER);
		...
		hBaseMasterEClass = createEClass(HBASE_MASTER);
		createEAttribute(hBaseMasterEClass, HBASE_MASTER__HBASEMASTER_ROOTDIR);
		createEReference(hBaseMasterEClass, HBASE_MASTER__HBASEMASTER_DEPEND_ON);
		createEReference(hBaseMasterEClass, HBASE_MASTER__HBASEMASTER_HOST_ON);

		hBaseRegionServerEClass = createEClass(HBASE_REGION_SERVER);
		createEAttribute(hBaseRegionServerEClass, HBASE_REGION_SERVER__HBASEREGIONSERVER_NAME);
		createEReference(hBaseRegionServerEClass, HBASE_REGION_SERVER__HBASEREGIONSERVER_CONNECT_TO);
		createEReference(hBaseRegionServerEClass, HBASE_REGION_SERVER__HBASEREGIONSERVER_HOST_ON);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getCloud_Hbasemaster(), this.getHBaseMaster(), null, "hbasemaster", null, 0, -1, Cloud.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCloud_Hbaseregionserver(), this.getHBaseRegionServer(), null, "hbaseregionserver", null, 0, -1, Cloud.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(hBaseMasterEClass, HBaseMaster.class, "HBaseMaster", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getHBaseMaster_Hbasemaster_rootdir(), ecorePackage.getEString(), "hbasemaster_rootdir", null, 0, 1, HBaseMaster.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getHBaseMaster_Hbasemaster_dependOn(), this.getHDFSNameNode(), null, "hbasemaster_dependOn", null, 0, 1, HBaseMaster.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getHBaseMaster_Hbasemaster_hostOn(), this.getServer(), null, "hbasemaster_hostOn", null, 0, 1, HBaseMaster.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(hBaseRegionServerEClass, HBaseRegionServer.class, "HBaseRegionServer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getHBaseRegionServer_Hbaseregionserver_name(), ecorePackage.getEString(), "hbaseregionserver_name", null, 0, 1, HBaseRegionServer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getHBaseRegionServer_Hbaseregionserver_connectTo(), this.getHBaseMaster(), null, "hbaseregionserver_connectTo", null, 1, 1, HBaseRegionServer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getHBaseRegionServer_Hbaseregionserver_hostOn(), this.getServer(), null, "hbaseregionserver_hostOn", null, 0, 1, HBaseRegionServer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
