...
public class HadoopmodelFactoryImpl extends EFactoryImpl implements HadoopmodelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case HadoopmodelPackage.HBASE_MASTER: return createHBaseMaster();
			case HadoopmodelPackage.HBASE_REGION_SERVER: return createHBaseRegionServer();
			default:
	 ...
	 * @generated
	 */
	public HBaseMaster createHBaseMaster() {
		HBaseMasterImpl hBaseMaster = new HBaseMasterImpl();
		return hBaseMaster;
	}
	 ...
	 * @generated
	 */
	public HBaseRegionServer createHBaseRegionServer() {
		HBaseRegionServerImpl hBaseRegionServer = new HBaseRegionServerImpl();
