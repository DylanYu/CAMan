...
public class HadoopmodelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case HadoopmodelPackage.HBASE_MASTER: {
				HBaseMaster hBaseMaster = (HBaseMaster)theEObject;
				T result = caseHBaseMaster(hBaseMaster);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HadoopmodelPackage.HBASE_REGION_SERVER: {
				HBaseRegionServer hBaseRegionServer = (HBaseRegionServer)theEObject;
				T result = caseHBaseRegionServer(hBaseRegionServer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>HBase Master</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>HBase Master</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHBaseMaster(HBaseMaster object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>HBase Region Server</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>HBase Region Server</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHBaseRegionServer(HBaseRegionServer object) {
		return null;
	}
