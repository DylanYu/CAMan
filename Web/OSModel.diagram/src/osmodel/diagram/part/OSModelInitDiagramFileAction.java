 ...
 * @generated
 */
public class OSModelInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new OSModelNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ClusterWrapEditPart.MODEL_ID));
		OSModelDiagramEditorUtil.runWizard(getShell(), wizard,
