 ...
 * @generated
 */
public class ApacheWrapItemSemanticEditPolicy extends
		OSModelBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ApacheWrapItemSemanticEditPolicy() {
		super(OSModelElementTypes.ApacheWrap_2004);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (OSModelVisualIDRegistry.getVisualID(incomingLink) == PHPWrapPhp_dependOnEditPart.VISUAL_ID) {
