 ...
 * @generated
 */
public class WebWrapItemSemanticEditPolicy extends
		OSModelBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public WebWrapItemSemanticEditPolicy() {
		super(OSModelElementTypes.WebWrap_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (OSModelVisualIDRegistry.getVisualID(outgoingLink) == WebWrapWeb_connectToEditPart.VISUAL_ID) {
			...
			if (OSModelVisualIDRegistry.getVisualID(outgoingLink) == WebWrapWeb_dependOnEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
