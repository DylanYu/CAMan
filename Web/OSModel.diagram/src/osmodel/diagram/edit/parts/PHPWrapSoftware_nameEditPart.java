 ...
 * @generated
 */
public class PHPWrapSoftware_nameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PHPWrapSoftware_nameEditPart(View view) {
		super(view);
	}
			...
			parser = OSModelParserProvider
					.getParser(
							...
							OSModelVisualIDRegistry
									.getType(osmodel.diagram.edit.parts.PHPWrapSoftware_nameEditPart.VISUAL_ID));
		}
		return parser;
	}
