 ...
 * @generated
 */
public class ApacheWrapSoftware_nameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ApacheWrapSoftware_nameEditPart(View view) {
		super(view);
	}
			...
			parser = OSModelParserProvider
					.getParser(
							...
							OSModelVisualIDRegistry
									.getType(osmodel.diagram.edit.parts.ApacheWrapSoftware_nameEditPart.VISUAL_ID));
		}
		return parser;
	}
