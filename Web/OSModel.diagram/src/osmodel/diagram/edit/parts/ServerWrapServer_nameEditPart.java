 ...
 * @generated
 */
public class ServerWrapServer_nameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ServerWrapServer_nameEditPart(View view) {
		super(view);
	}
			...
			parser = OSModelParserProvider
					.getParser(
							...
							OSModelVisualIDRegistry
									.getType(osmodel.diagram.edit.parts.ServerWrapServer_nameEditPart.VISUAL_ID));
		}
		return parser;
	}
