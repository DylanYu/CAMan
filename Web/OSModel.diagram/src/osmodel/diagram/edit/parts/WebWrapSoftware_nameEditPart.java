...
import osmodel.diagram.edit.policies.OSModelTextSelectionEditPolicy;
 ...
 * @generated
 */
public class WebWrapSoftware_nameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public WebWrapSoftware_nameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new OSModelTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return OSModelElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OSModelParserProvider
					.getParser(
							OSModelElementTypes.WebWrap_2001,
							getParserElement(),
							OSModelVisualIDRegistry
									.getType(osmodel.diagram.edit.parts.WebWrapSoftware_nameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					OSModelEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
