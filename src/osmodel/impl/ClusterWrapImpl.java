 ...
 * @generated
 */
public class ClusterWrapImpl extends WrappingEObjectImpl implements ClusterWrap
{
  /**
   ...
   * @ordered
   */
  protected EList<WebWrap> softwares;
...
return core;
  ...
  public List listSubCores(int featureID){
    ...
    LinkedList<String> core=(LinkedList<String>)this.getCore();
    if(core==null) 
      return result;
    switch(featureID){
  ...
  public EList<ServerWrap> getServers()
  {
    ...
    if (servers == null)
    {
      ...
      servers = new EObjectContainmentWithInverseEList<ServerWrap>(ServerWrap.class, this, OsmodelPackage.CLUSTER_WRAP__SERVERS, OsmodelPackage.SERVER_WRAP__BELONG_TO);
    
      servers = new EObjectContainmentEListForWrapping<ServerWrap>(
          ServerWrap.class, 
          this, 
          OsmodelPackage.CLUSTER_WRAP__SERVERS,
   ...
   * @generated
   */
  public EList<WebWrap> getSoftwares()
  {
    ...
    if (softwares == null)
    {
      ...
      softwares = new EObjectContainmentWithInverseEList<WebWrap>(WebWrap.class, this, OsmodelPackage.CLUSTER_WRAP__SOFTWARES, OsmodelPackage.WEB_WRAP__BELONG_TO);
    
      softwares = new EObjectContainmentEListForWrapping<WebWrap>(
          WebWrap.class, 
          this, 
          OsmodelPackage.CLUSTER_WRAP__SOFTWARES,
          OsmodelPackage.eINSTANCE.getWebWrap()
        );
  ...
  {
        Object result=null;
        LinkedList<String> core=(LinkedList<String>)getCore();
        if(core==null) return name;	
        //System.out.println("Get cluster name");
    return name; 
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
      ...
      if(core==null) return;
        ...
        System.out.println("Set cluster name");
final LinkedList<String> ctrl=core;
if (ctrl.size() == 0) ctrl.add(name);
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case OsmodelPackage.CLUSTER_WRAP__SOFTWARES:
        getSoftwares().clear();
        getSoftwares().addAll((Collection<? extends WebWrap>)newValue);
        return;
      case OsmodelPackage.CLUSTER_WRAP__NAME:
