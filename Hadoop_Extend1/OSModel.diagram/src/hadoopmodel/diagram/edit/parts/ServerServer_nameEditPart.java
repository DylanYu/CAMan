 ...
 * @generated
 */
public class ServerServer_nameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ServerServer_nameEditPart(View view) {
		super(view);
	}
			...
			parser = HadoopStackParserProvider
					.getParser(
							...
							HadoopStackVisualIDRegistry
									.getType(hadoopmodel.diagram.edit.parts.ServerServer_nameEditPart.VISUAL_ID));
		}
		return parser;
	}
