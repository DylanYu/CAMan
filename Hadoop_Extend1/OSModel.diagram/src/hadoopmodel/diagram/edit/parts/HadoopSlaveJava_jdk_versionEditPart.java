 ...
 * @generated
 */
public class HadoopSlaveJava_jdk_versionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public HadoopSlaveJava_jdk_versionEditPart(View view) {
		super(view);
	}
			...
			parser = HadoopStackParserProvider
					.getParser(
							...
							HadoopStackVisualIDRegistry
									.getType(hadoopmodel.diagram.edit.parts.HadoopSlaveJava_jdk_versionEditPart.VISUAL_ID));
		}
		return parser;
	}
