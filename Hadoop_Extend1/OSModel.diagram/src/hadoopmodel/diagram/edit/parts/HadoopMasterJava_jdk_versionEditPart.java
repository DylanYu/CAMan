 ...
 * @generated
 */
public class HadoopMasterJava_jdk_versionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public HadoopMasterJava_jdk_versionEditPart(View view) {
		super(view);
	}
			...
			parser = HadoopStackParserProvider
					.getParser(
							...
							HadoopStackVisualIDRegistry
									.getType(hadoopmodel.diagram.edit.parts.HadoopMasterJava_jdk_versionEditPart.VISUAL_ID));
		}
		return parser;
	}
