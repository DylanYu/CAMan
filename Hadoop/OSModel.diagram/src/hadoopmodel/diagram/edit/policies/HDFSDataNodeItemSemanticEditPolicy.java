 ...
 * @generated
 */
public class HDFSDataNodeItemSemanticEditPolicy extends
		HadoopStackBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public HDFSDataNodeItemSemanticEditPolicy() {
		super(HadoopStackElementTypes.HDFSDataNode_2004);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (HadoopStackVisualIDRegistry.getVisualID(outgoingLink) == HDFSDataNodeHdfsdatanode_hostOnEditPart.VISUAL_ID) {
			...
			if (HadoopStackVisualIDRegistry.getVisualID(outgoingLink) == HDFSDataNodeHdfsdatanode_connectToEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
