 ...
 * @generated
 */
public class TaskTrackerItemSemanticEditPolicy extends
		HadoopStackBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public TaskTrackerItemSemanticEditPolicy() {
		super(HadoopStackElementTypes.TaskTracker_2006);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (HadoopStackVisualIDRegistry.getVisualID(outgoingLink) == TaskTrackerTasktracker_connectToEditPart.VISUAL_ID) {
			...
			if (HadoopStackVisualIDRegistry.getVisualID(outgoingLink) == TaskTrackerTasktracker_hostOnEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
