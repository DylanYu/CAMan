 ...
 * @generated
 */
public class TaskTrackerTasktracker_data_dirEditPart extends
	 ...
	 * @generated
	 */
	public TaskTrackerTasktracker_data_dirEditPart(View view) {
		super(view);
	}
			...
			parser = HadoopStackParserProvider
					.getParser(
							...
							HadoopStackVisualIDRegistry
									.getType(hadoopmodel.diagram.edit.parts.TaskTrackerTasktracker_data_dirEditPart.VISUAL_ID));
		}
		return parser;
	}
