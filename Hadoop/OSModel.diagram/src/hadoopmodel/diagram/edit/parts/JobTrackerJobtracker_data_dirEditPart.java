 ...
 * @generated
 */
public class JobTrackerJobtracker_data_dirEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public JobTrackerJobtracker_data_dirEditPart(View view) {
		super(view);
	}
			...
			parser = HadoopStackParserProvider
					.getParser(
							...
							HadoopStackVisualIDRegistry
									.getType(hadoopmodel.diagram.edit.parts.JobTrackerJobtracker_data_dirEditPart.VISUAL_ID));
		}
		return parser;
	}
