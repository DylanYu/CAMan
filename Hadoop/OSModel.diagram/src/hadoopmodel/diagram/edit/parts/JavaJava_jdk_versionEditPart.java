 ...
 * @generated
 */
public class JavaJava_jdk_versionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public JavaJava_jdk_versionEditPart(View view) {
		super(view);
	}
			...
			parser = HadoopStackParserProvider
					.getParser(
							...
							HadoopStackVisualIDRegistry
									.getType(hadoopmodel.diagram.edit.parts.JavaJava_jdk_versionEditPart.VISUAL_ID));
		}
		return parser;
	}
