 ...
 * @generated
 */
public class TaskTrackerTasktracker_hostOnReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public TaskTrackerTasktracker_hostOnReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Server && newEnd instanceof TaskTracker)) {
			return false;
		}
		return HadoopStackBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTaskTrackerTasktracker_hostOn_4007(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return HadoopStackBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTaskTrackerTasktracker_hostOn_4007(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setTasktracker_hostOn(null);
		getNewSource().setTasktracker_hostOn(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setTasktracker_hostOn(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
