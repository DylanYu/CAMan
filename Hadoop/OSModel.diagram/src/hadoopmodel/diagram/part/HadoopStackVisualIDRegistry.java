...
public class HadoopStackVisualIDRegistry {
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case CloudEditPart.VISUAL_ID:
			...
			if (HadoopmodelPackage.eINSTANCE.getTaskTracker().isSuperTypeOf(
					domainElement.eClass())) {
				return TaskTrackerEditPart.VISUAL_ID;
			}
			if (HadoopmodelPackage.eINSTANCE.getJobTracker().isSuperTypeOf(
					domainElement.eClass())) {
				return JobTrackerEditPart.VISUAL_ID;
			}
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case CloudEditPart.VISUAL_ID:
			...
			if (TaskTrackerEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (JobTrackerEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case TaskTrackerEditPart.VISUAL_ID:
			if (TaskTrackerTasktracker_data_dirEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case JobTrackerEditPart.VISUAL_ID:
			if (JobTrackerJobtracker_data_dirEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
