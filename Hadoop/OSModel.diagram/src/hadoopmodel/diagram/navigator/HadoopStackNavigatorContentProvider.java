...
public class HadoopStackNavigatorContentProvider implements
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case CloudEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					HadoopStackVisualIDRegistry
							.getType(TaskTrackerEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					HadoopStackVisualIDRegistry
							.getType(JobTrackerEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
			...
			connectedViews = getDiagramLinksByType(
					Collections.singleton(sv),
					HadoopStackVisualIDRegistry
							.getType(JobTrackerJobtracker_hostOnEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(
					Collections.singleton(sv),
					HadoopStackVisualIDRegistry
			...
			connectedViews = getDiagramLinksByType(
					Collections.singleton(sv),
					HadoopStackVisualIDRegistry
							.getType(TaskTrackerTasktracker_connectToEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(
					Collections.singleton(sv),
					HadoopStackVisualIDRegistry
			...
			connectedViews = getDiagramLinksByType(
					Collections.singleton(sv),
					HadoopStackVisualIDRegistry
							.getType(TaskTrackerTasktracker_hostOnEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(
					Collections.singleton(sv),
					HadoopStackVisualIDRegistry
							.getType(JobTrackerJobtracker_dependOnEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
		...
		case JobTrackerEditPart.VISUAL_ID: {
			...
			HadoopStackNavigatorGroup outgoinglinks = new HadoopStackNavigatorGroup(
					Messages.NavigatorGroupName_JobTracker_2002_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			HadoopStackNavigatorGroup incominglinks = new HadoopStackNavigatorGroup(
					Messages.NavigatorGroupName_JobTracker_2002_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
		...
		case TaskTrackerEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			HadoopStackNavigatorGroup outgoinglinks = new HadoopStackNavigatorGroup(
					Messages.NavigatorGroupName_TaskTracker_2006_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(
					Collections.singleton(sv),
		...
		case JobTrackerJobtracker_dependOnEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			HadoopStackNavigatorGroup target = new HadoopStackNavigatorGroup(
					Messages.NavigatorGroupName_JobTrackerJobtracker_dependOn_4002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			HadoopStackNavigatorGroup source = new HadoopStackNavigatorGroup(
					Messages.NavigatorGroupName_JobTrackerJobtracker_dependOn_4002_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					HadoopStackVisualIDRegistry
		...
		case JobTrackerJobtracker_hostOnEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			HadoopStackNavigatorGroup target = new HadoopStackNavigatorGroup(
					Messages.NavigatorGroupName_JobTrackerJobtracker_hostOn_4003_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			HadoopStackNavigatorGroup source = new HadoopStackNavigatorGroup(
					Messages.NavigatorGroupName_JobTrackerJobtracker_hostOn_4003_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					HadoopStackVisualIDRegistry
		...
		case TaskTrackerTasktracker_connectToEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			HadoopStackNavigatorGroup target = new HadoopStackNavigatorGroup(
					Messages.NavigatorGroupName_TaskTrackerTasktracker_connectTo_4004_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			HadoopStackNavigatorGroup source = new HadoopStackNavigatorGroup(
					Messages.NavigatorGroupName_TaskTrackerTasktracker_connectTo_4004_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					HadoopStackVisualIDRegistry
		...
		case TaskTrackerTasktracker_hostOnEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			HadoopStackNavigatorGroup target = new HadoopStackNavigatorGroup(
					Messages.NavigatorGroupName_TaskTrackerTasktracker_hostOn_4007_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			HadoopStackNavigatorGroup source = new HadoopStackNavigatorGroup(
					Messages.NavigatorGroupName_TaskTrackerTasktracker_hostOn_4007_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					HadoopStackVisualIDRegistry
