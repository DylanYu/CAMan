 ...
 *   <li>{@link hadoopmodel.Cloud#getHadoopmaster <em>Hadoopmaster</em>}</li>
 *   <li>{@link hadoopmodel.Cloud#getHadoopslave <em>Hadoopslave</em>}</li>
 *   <li>{@link hadoopmodel.Cloud#getHadoopcluster <em>Hadoopcluster</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Cloud extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Hadoopmaster</b></em>' containment reference list.
	 * The list contents are of type {@link hadoopmodel.HadoopMaster}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Hadoopmaster</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Hadoopmaster</em>' containment reference list.
	 * @see hadoopmodel.HadoopmodelPackage#getCloud_Hadoopmaster()
	 * @model containment="true"
	 * @generated
	 */
	EList<HadoopMaster> getHadoopmaster();

	/**
	 * Returns the value of the '<em><b>Hadoopslave</b></em>' containment reference list.
	 * The list contents are of type {@link hadoopmodel.HadoopSlave}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Hadoopslave</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Hadoopslave</em>' containment reference list.
	 * @see hadoopmodel.HadoopmodelPackage#getCloud_Hadoopslave()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Hadoopcluster</b></em>' containment reference list.
	 * The list contents are of type {@link hadoopmodel.HadoopCluster}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Hadoopcluster</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Hadoopcluster</em>' containment reference list.
	 * @see hadoopmodel.HadoopmodelPackage#getCloud_Hadoopcluster()
	 * @model containment="true"
	 * @generated
	 */
	EList<HadoopCluster> getHadoopcluster();
