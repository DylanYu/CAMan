...
public class HadoopmodelAdapterFactory extends AdapterFactoryImpl {
	...
	protected HadoopmodelSwitch<Adapter> modelSwitch =
		new HadoopmodelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseHadoopCluster(HadoopCluster object) {
				return createHadoopClusterAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link hadoopmodel.HadoopCluster <em>Hadoop Cluster</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createHadoopClusterAdapter() {
		return null;
	}
