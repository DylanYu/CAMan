...
public class HadoopmodelPackageImpl extends EPackageImpl implements HadoopmodelPackage {
	 ...
	 * @generated
	 */
	private EClass hadoopClusterEClass = null;
	 ...
	 * @generated
	 */
	public EReference getCloud_Hadoopmaster() {
	 ...
	 * @generated
	 */
	public EReference getCloud_Hadoopslave() {
	 ...
	 * @generated
	 */
	public EReference getCloud_Hadoopcluster() {
		return (EReference)cloudEClass.getEStructuralFeatures().get(11);
	}
	 ...
	 * @generated
	 */
	public EReference getHadoopMaster_Hadoopmaster_hostOn() {
	 ...
	 * @generated
	 */
	public EReference getHadoopSlave_Hadoopslave_connectTo() {
	 ...
	 * @generated
	 */
	public EReference getHadoopSlave_Hadoopslave_hostOn() {
		return (EReference)hadoopSlaveEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getHadoopCluster() {
		return hadoopClusterEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getHadoopCluster_Hadoopcluster_master_hostOn() {
		return (EReference)hadoopClusterEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getHadoopCluster_Hadoopcluster_slave_hostOn() {
		return (EReference)hadoopClusterEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(cloudEClass, CLOUD__HADOOPMASTER);
		createEReference(cloudEClass, CLOUD__HADOOPSLAVE);
		createEReference(cloudEClass, CLOUD__HADOOPCLUSTER);
		...
		createEReference(hadoopMasterEClass, HADOOP_MASTER__HADOOPMASTER_HOST_ON);

		hadoopSlaveEClass = createEClass(HADOOP_SLAVE);
		createEReference(hadoopSlaveEClass, HADOOP_SLAVE__HADOOPSLAVE_CONNECT_TO);
		createEReference(hadoopSlaveEClass, HADOOP_SLAVE__HADOOPSLAVE_HOST_ON);

		hadoopClusterEClass = createEClass(HADOOP_CLUSTER);
		createEReference(hadoopClusterEClass, HADOOP_CLUSTER__HADOOPCLUSTER_MASTER_HOST_ON);
		createEReference(hadoopClusterEClass, HADOOP_CLUSTER__HADOOPCLUSTER_SLAVE_HOST_ON);
	}
	...
	public void initializePackageContents() {
		...
		hadoopMasterEClass.getESuperTypes().add(this.getJava());
		hadoopMasterEClass.getESuperTypes().add(this.getHDFSNameNode());
		hadoopMasterEClass.getESuperTypes().add(this.getJobTracker());
		hadoopSlaveEClass.getESuperTypes().add(this.getJava());
		hadoopSlaveEClass.getESuperTypes().add(this.getHDFSDataNode());
		hadoopSlaveEClass.getESuperTypes().add(this.getTaskTracker());
		hadoopClusterEClass.getESuperTypes().add(this.getHadoopMaster());
		hadoopClusterEClass.getESuperTypes().add(this.getHadoopSlave());
		...
		initEReference(getCloud_Hadoopmaster(), this.getHadoopMaster(), null, "hadoopmaster", null, 0, -1, Cloud.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCloud_Hadoopslave(), this.getHadoopSlave(), null, "hadoopslave", null, 0, -1, Cloud.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCloud_Hadoopcluster(), this.getHadoopCluster(), null, "hadoopcluster", null, 0, -1, Cloud.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getHadoopMaster_Hadoopmaster_hostOn(), this.getServer(), null, "hadoopmaster_hostOn", null, 0, 1, HadoopMaster.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(hadoopSlaveEClass, HadoopSlave.class, "HadoopSlave", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getHadoopSlave_Hadoopslave_connectTo(), this.getHadoopMaster(), null, "hadoopslave_connectTo", null, 1, 1, HadoopSlave.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getHadoopSlave_Hadoopslave_hostOn(), this.getServer(), null, "hadoopslave_hostOn", null, 0, 1, HadoopSlave.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(hadoopClusterEClass, HadoopCluster.class, "HadoopCluster", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getHadoopCluster_Hadoopcluster_master_hostOn(), this.getServer(), null, "hadoopcluster_master_hostOn", null, 0, 1, HadoopCluster.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getHadoopCluster_Hadoopcluster_slave_hostOn(), this.getServer(), null, "hadoopcluster_slave_hostOn", null, 0, -1, HadoopCluster.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
