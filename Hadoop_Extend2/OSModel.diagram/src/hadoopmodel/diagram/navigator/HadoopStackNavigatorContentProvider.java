	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case HadoopClusterEditPart.VISUAL_ID: {
			...
			HadoopStackNavigatorGroup outgoinglinks = new HadoopStackNavigatorGroup(
					Messages.NavigatorGroupName_HadoopCluster_2009_outgoinglinks,
		...
		case HadoopClusterHadoopcluster_master_hostOnEditPart.VISUAL_ID: {
			...
			HadoopStackNavigatorGroup target = new HadoopStackNavigatorGroup(
					Messages.NavigatorGroupName_HadoopClusterHadoopcluster_master_hostOn_4012_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			HadoopStackNavigatorGroup source = new HadoopStackNavigatorGroup(
					Messages.NavigatorGroupName_HadoopClusterHadoopcluster_master_hostOn_4012_source,
		...
		case HadoopClusterHadoopcluster_slave_hostOnEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			HadoopStackNavigatorGroup target = new HadoopStackNavigatorGroup(
					Messages.NavigatorGroupName_HadoopClusterHadoopcluster_slave_hostOn_4013_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			HadoopStackNavigatorGroup source = new HadoopStackNavigatorGroup(
					Messages.NavigatorGroupName_HadoopClusterHadoopcluster_slave_hostOn_4013_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					HadoopStackVisualIDRegistry
