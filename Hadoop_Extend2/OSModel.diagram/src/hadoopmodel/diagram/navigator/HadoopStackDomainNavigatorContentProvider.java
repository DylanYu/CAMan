 ...
 * @generated
 */
public class HadoopStackDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public HadoopStackDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof HadoopStackDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((HadoopStackDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new HadoopStackDomainNavigatorItem(
