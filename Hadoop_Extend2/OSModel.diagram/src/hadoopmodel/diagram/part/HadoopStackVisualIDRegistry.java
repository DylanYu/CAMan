...
public class HadoopStackVisualIDRegistry {
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case CloudEditPart.VISUAL_ID:
			if (HadoopmodelPackage.eINSTANCE.getHadoopCluster().isSuperTypeOf(
					domainElement.eClass())) {
				return HadoopClusterEditPart.VISUAL_ID;
			}
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		switch (containerVisualID) {
		case CloudEditPart.VISUAL_ID:
			if (HadoopClusterEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case HadoopClusterEditPart.VISUAL_ID:
			if (HadoopClusterJava_jdk_versionEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
