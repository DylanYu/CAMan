 ...
 * @generated
 */
public class HadoopClusterHadoopcluster_slave_hostOnReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public HadoopClusterHadoopcluster_slave_hostOnReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return HadoopStackBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistHadoopClusterHadoopcluster_slave_hostOn_4013(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getHadoopcluster_slave_hostOn().remove(getOldTarget());
		getNewSource().getHadoopcluster_slave_hostOn().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getHadoopcluster_slave_hostOn().remove(getOldTarget());
		getOldSource().getHadoopcluster_slave_hostOn().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
