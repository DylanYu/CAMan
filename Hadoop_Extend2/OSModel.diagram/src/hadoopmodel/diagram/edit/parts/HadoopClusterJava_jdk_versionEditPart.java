 ...
 * @generated
 */
public class HadoopClusterJava_jdk_versionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public HadoopClusterJava_jdk_versionEditPart(View view) {
		super(view);
	}
			...
			parser = HadoopStackParserProvider
					.getParser(
							...
							HadoopStackVisualIDRegistry
									.getType(hadoopmodel.diagram.edit.parts.HadoopClusterJava_jdk_versionEditPart.VISUAL_ID));
		}
		return parser;
	}
