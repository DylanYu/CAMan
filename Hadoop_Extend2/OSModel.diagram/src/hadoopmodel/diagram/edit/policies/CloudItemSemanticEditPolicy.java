...
import hadoopmodel.diagram.edit.commands.HadoopClusterCreateCommand;
...
public class CloudItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (HadoopStackElementTypes.HadoopCluster_2009 == req.getElementType()) {
			return getGEFWrapper(new HadoopClusterCreateCommand(req));
		}
