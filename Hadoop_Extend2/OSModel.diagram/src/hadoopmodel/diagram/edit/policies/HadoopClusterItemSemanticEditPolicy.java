 ...
 * @generated
 */
public class HadoopClusterItemSemanticEditPolicy extends
		HadoopStackBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public HadoopClusterItemSemanticEditPolicy() {
		super(HadoopStackElementTypes.HadoopCluster_2009);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (HadoopStackVisualIDRegistry.getVisualID(outgoingLink) == HadoopClusterHadoopcluster_master_hostOnEditPart.VISUAL_ID) {
			...
			if (HadoopStackVisualIDRegistry.getVisualID(outgoingLink) == HadoopClusterHadoopcluster_slave_hostOnEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
