...
public class CloudItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HadoopmodelPackage.Literals.CLOUD__HADOOPMASTER);
			childrenFeatures.add(HadoopmodelPackage.Literals.CLOUD__HADOOPSLAVE);
			childrenFeatures.add(HadoopmodelPackage.Literals.CLOUD__HADOOPCLUSTER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HadoopmodelPackage.Literals.CLOUD__JAVA,
				 HadoopmodelFactory.eINSTANCE.createHadoopMaster()));

		newChildDescriptors.add
			(createChildParameter
				(HadoopmodelPackage.Literals.CLOUD__JAVA,
				 HadoopmodelFactory.eINSTANCE.createHadoopSlave()));

		newChildDescriptors.add
			(createChildParameter
				(HadoopmodelPackage.Literals.CLOUD__JAVA,
				 HadoopmodelFactory.eINSTANCE.createHadoopCluster()));
		...
		newChildDescriptors.add
			(createChildParameter
				(HadoopmodelPackage.Literals.CLOUD__HADOOPMASTER,
				 HadoopmodelFactory.eINSTANCE.createHadoopMaster()));
		...
		newChildDescriptors.add
			(createChildParameter
				(HadoopmodelPackage.Literals.CLOUD__HADOOPSLAVE,
				 HadoopmodelFactory.eINSTANCE.createHadoopSlave()));
		...
		newChildDescriptors.add
			(createChildParameter
				(HadoopmodelPackage.Literals.CLOUD__HADOOPCLUSTER,
				 HadoopmodelFactory.eINSTANCE.createHadoopCluster()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == HadoopmodelPackage.Literals.CLOUD__JAVA ||
			childFeature == HadoopmodelPackage.Literals.CLOUD__JOBTRACKER ||
			childFeature == HadoopmodelPackage.Literals.CLOUD__HDFSNAMENODE ||
			childFeature == HadoopmodelPackage.Literals.CLOUD__HADOOPMASTER ||
			childFeature == HadoopmodelPackage.Literals.CLOUD__TASKTRACKER ||
			childFeature == HadoopmodelPackage.Literals.CLOUD__HDFSDATANODE ||
			childFeature == HadoopmodelPackage.Literals.CLOUD__HADOOPSLAVE ||
			childFeature == HadoopmodelPackage.Literals.CLOUD__HADOOPCLUSTER;
